...
const columns = [
    /* { label: 'Department Id', fieldName: 'department_id',sortable: true, type: 'number',initialWidth: 50, },*/
     { label: 'Fleet Name', fieldName: 'fleet_name',sortable: true, type : 'text',},
     {
         label: "Created Date",
...
export default class ListfleetsComponent extends LightningElement {
    ...
    connectedCallback(){
      ...
      loaddata(authorisationdata){
        getFleetsdata({authdata:authorisationdata})
        .then(data => {
            debugger
            //alert('Inside Wire');
