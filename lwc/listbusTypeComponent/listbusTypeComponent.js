...
import getBusTypedata from '@salesforce/apex/masterDataController.getBusTypedata';

const columns = [
    { label: 'Bus Type Id', fieldName: 'bustype_id',sortable: true, type: 'number', },
    { label: 'Bus Type', fieldName: 'bustype_name',sortable: true, type : 'text',},
    {
        label: "Created Date",
...
export default class ListbusTypeComponent extends LightningElement {
    ...
    connectedCallback(){
      ...
      loaddata(authorisationdata){
        getBusTypedata({authdata:authorisationdata})
        .then(data => {
            debugger
            //alert('Inside Wire');
            ...
            // Set table data
            this.bustypeList = data.objectdata;
            this.showTable = true;
