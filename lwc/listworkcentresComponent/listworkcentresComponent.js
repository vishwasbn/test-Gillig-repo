...
import getWorkcentredata from '@salesforce/apex/masterDataController.getWorkcentredata';
...
export default class ListworkcentresComponent extends LightningElement {
    ...
    @track sortedBy;
    @track workcentreList;
    @track factoryoptions;
    @track depatmentoptions;
    @track defaultFactory = 'None';
    @track defaultDepartment = 'None';
    ...
    connectedCallback(){
      ...
      loaddata(authorisationdata){
        getWorkcentredata({authdata:authorisationdata})
        .then(data => {
            debugger
            //alert('Inside Wire');
            ...
            // Set table data
            this.workcentreList = data.objectdata;
            this.factoryoptions = data.factoryPickList;
            this.departmentoptions = data.departmentPickList;
            this.showTable = true;
