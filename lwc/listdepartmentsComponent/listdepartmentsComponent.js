...
const columns = [
   /* { label: 'Department Id', fieldName: 'department_id',sortable: true, type: 'number',initialWidth: 50, },*/
    { label: 'Department Name', fieldName: 'department_name',sortable: true, type : 'text',},
    {
        label: "Created Date",
...
export default class ListdepartmentsComponent extends LightningElement {
    ...
    connectedCallback(){
      ...
      loaddata(authorisationdata){
        ...
        .then(data => {
            ...
            // Set table data
            this.deparmentList = data.objectdata;
