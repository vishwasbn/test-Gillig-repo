...
import getBusStatusdata from '@salesforce/apex/masterDataController.getBusStatusdata';

//{ label: 'Last Name', fieldName: 'last_name',sortable: true, },

const columns = [
    { label: 'Bus Status Id', fieldName: 'busstatus_id',sortable: true, type: 'number', },
    { label: 'Bus Status', fieldName: 'busstatus_name',sortable: true, type : 'text',},
    {
        label: "Created Date",
...
export default class ListbusStatusComponent extends LightningElement {
    ...
    connectedCallback(){
      ...
      loaddata(authorisationdata){
        getBusStatusdata({authdata:authorisationdata})
        .then(data => {
            debugger
            //alert('Inside Wire');
            ...
            // Set table data
            this.busstatusList = data.objectdata;
            this.showTable = true;
