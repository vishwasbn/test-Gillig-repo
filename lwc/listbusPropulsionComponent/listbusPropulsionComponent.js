...
import getBusPropulsionsdata from '@salesforce/apex/masterDataController.getBusPropulsionsdata';

const columns = [
    { label: 'Bus Propulsion Id', fieldName: 'buspropulsion_id',sortable: true, type: 'number', },
    { label: 'Bus Propulsion', fieldName: 'buspropulsion_name',sortable: true, type : 'text',},
    {
        label: "Created Date",
...
export default class ListbusPropulsionComponent extends LightningElement {
    ...
    connectedCallback(){
      ...
      loaddata(authorisationdata){
        getBusPropulsionsdata({authdata:authorisationdata})
        .then(data => {
            debugger
            //alert('Inside Wire');
            ...
            // Set table data
            this.buspropulsionList = data.objectdata;
            this.showTable = true;
        ...
        .catch(error => {
            this.error = error;
            this.buspropulsionList = undefined;
        });
    }
